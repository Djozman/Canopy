...
extension TorrentState {
    var color: Color {
        switch self {
        case .downloading, .downloadingMetadata: return CanopyPalette.download
        case .seeding:                           return CanopyPalette.positive
        case .finished:                          return CanopyPalette.positive
        case .checkingFiles, .checkingResumeData,
             .allocating:                        return CanopyPalette.warning
        }
    }
}
...
extension TorrentStatus {
    var statusColor: Color {
        if errorMessage != nil { return CanopyPalette.danger }
