...
plutil -replace CFBundleVersion -string 2.3 Canopy.app/Contents/Info.plist
plutil -replace CFBundleShortVersionString -string 2.3 Canopy.app/Contents/Info.plist
