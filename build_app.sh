...
plutil -replace CFBundleVersion -string 2.4.2 Canopy.app/Contents/Info.plist
plutil -replace CFBundleShortVersionString -string 2.4.2 Canopy.app/Contents/Info.plist
