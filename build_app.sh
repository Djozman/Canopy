...
plutil -replace CFBundleVersion -string 2.4.1 Canopy.app/Contents/Info.plist
plutil -replace CFBundleShortVersionString -string 2.4.1 Canopy.app/Contents/Info.plist
